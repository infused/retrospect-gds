    ...
    <td align="center" valign="middle">
      <form name="loginform" id="loginform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <table width="450" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="75" align="right" valign="bottom" nowrap="nowrap" background="images/retrospect-logo.jpg" class="vertext">(v<?php echo RGDS_VERSION; ?>)&nbsp;</td>
          </tr>
          <tr>
            <td align="center" valign="middle">						<table width="100%"  border="1" cellpadding="20" cellspacing="0" bordercolor="#CCCCCC">
              <tr>
