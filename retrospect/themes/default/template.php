...
<div id="content">
	<div id="utils">
		...
		<a href="#" onclick="MM_openBrWindow('<?php echo htmlentities($_SERVER['PHP_SELF'].'?option=email&print=y'); ?> ','','scrollbars=yes,resizable=yes,width=400,height=225')"><img src="themes/default/images/emailbutton.gif" border="0" alt="<?php echo gtc("E-mail this to a friend"); ?>" /></a>
	</div>
