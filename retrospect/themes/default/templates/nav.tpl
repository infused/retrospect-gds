...
<table class="tab-row" cellpadding="0" cellspacing="0">
	<tr>
		...
		{else}
			<td class="tab">
				<a href="{$php_self}?option=family&amp;id={$indiv->indkey}">{php}t("Family"){/php}</a>
			</td>
		{/if}
		{if $option=="pedigree"}
		...
		{else}
			<td class="tab">
				<a href="{$php_self}?option=pedigree&amp;id={$indiv->indkey}">{php}t("Pedigree"){/php}</a>
			</td>
		{/if}
		{if $option=="reports"}
		...
		{elseif $option=="ahnentafel" or $option=="descendant"}
			<td class="tab-selected">
				<a href="{$php_self}?option=reports&amp;id={$indiv->indkey}">{php}t("Reports"){/php}</a>
			</td>
		{else}
			<td class="tab">
				<a href="{$php_self}?option=reports&amp;id={$indiv->indkey}">{php}t("Reports"){/php}</a>
		...
		{else}
			<td class="tab">
				<a href="{$php_self}?option=multimedia&amp;id={$indiv->indkey}">{php}t("Multimedia"){/php}</a>
			</td>
		{/if}
